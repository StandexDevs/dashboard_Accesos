...
<head>
    ...
    <title>Dashboard Accesos | Login</title>
    <!-- Favicon icon -->
                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <h4 class="text-center mb-4 text-white">Panel de administración de accesos</h4>
                                    <?php echo form_open('/auth/login', ['id' => 'formLogin']);?>
                                        <form action="index.html">
                                            <div class="form-group">
                                                <label class="mb-1 text-white"><strong>Código de acceso del evento</strong></label>
                                            ...
                                            <div class="form-row d-flex justify-content-between mt-4 mb-2">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox ms-1 text-white">
                                                        ...
                                                        <label class="custom-control-label" for="basic_checkbox_1">Guardar datos</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="text-center">
                                                <?php echo form_submit('submit', 'Ingresar', ['class' => 'btn bg-white text-primary btn-block']);?>
                                            </div>
                                        </form>
                                    <?php echo form_close();?>
                                </div>
