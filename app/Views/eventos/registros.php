...
<?= $this->endSection()?>
    <div class="card">
        <div class="card-header d-block d-sm-flex border-0">
            <div class="me-3">
                <h4 class="fs-20 text-black">Bitacora de entrada</h4>
                    ...
                    <table class="table table-responsive-md card-table previous-transactions">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <h6 class="fs-16 font-w600 mb-0">XYZ Store ID</h6>
                                ...
                                <td>
                                    <span class="fs-16 text-black font-w500">+$5,553</span>
                                </td>
                                <td>
                                    <span class="text-success fs-16 font-w500 text-end d-block">Completed</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
